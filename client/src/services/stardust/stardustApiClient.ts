...
export class StardustApiClient extends ApiClient {
  ...
  public async basicOutputsDetails(request: IAddressDetailsRequest): Promise<IAddressDetailsResponse> {
    return this.callApi<unknown, IAddressDetailsResponse>(`stardust/address/outputs/basic/${request.network}/${request.address}`, "get");
  }
  ...
  public async aliasOutputsDetails(request: IAddressDetailsRequest): Promise<IAddressDetailsResponse> {
    return this.callApi<unknown, IAddressDetailsResponse>(`stardust/address/outputs/alias/${request.network}/${request.address}`, "get");
  }
  ...
  public async transactionIncludedBlockDetails(request: ITransactionDetailsRequest): Promise<ITransactionDetailsResponse> {
    return this.callApi<unknown, ITransactionDetailsResponse>(`stardust/transaction/${request.network}/${request.transactionId}`, "get");
  }
  ...
  public async milestoneStats(request: IMilestoneStatsRequest): Promise<IMilestoneAnalyticStats> {
    return this.callApi<unknown, IMilestoneAnalyticStats>(`stardust/milestone/stats/${request.network}/${request.milestoneIndex}`, "get");
  }
  ...
  public async milestoneReferencedBlocks(request: { network: string; milestoneId: string }): Promise<IMilestoneBlocksResponse> {
    return this.callApi<unknown, IMilestoneBlocksResponse>(`stardust/milestone/blocks/${request.network}/${request.milestoneId}`, "get");
  }
  ...
  public async participationEventDetails(request: IParticipationEventRequest): Promise<IParticipationEventResponse> {
    return this.callApi<unknown, IParticipationEventResponse>(`stardust/participation/events/${request.network}/${request.eventId}`, "get");
  }
