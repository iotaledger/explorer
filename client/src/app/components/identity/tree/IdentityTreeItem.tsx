          ...
          <Fragment>
            {(this.state.diffHistory?.chainData?.length === 0 || this.state.loadingChildren || this.state.error) && (
              <div className="expand-animation">
                ...
                {!this.state.loadingChildren && (this.state.diffHistory?.chainData?.length === 0 || this.state.error) && (
                  <div className="tree-item-container">
                    {!this.props.firstMsg && (
                      <Fragment>
                        <div className="lower-left-straight-line" />
                    ...
                    {this.state.diffHistory?.chainData?.length === 0 && <p className="title no-diff-title"> No diffs found</p>}
              ...
              this.state.diffHistory?.chainData?.map((value, index) => (
                <div key={index} className="expand-animation">
                  <IdentityTreeItem
                    ...
                    onItemClick={(content) => {
                      this.props.onItemClick(content, this.getPreviousMessages(content.messageId));
                    }}
          ...
          >
            ...
            <div>
              ...
              {this.props.itemMessage.document?.meta?.updated ?
                <p className="time-stamp">{moment(this.props.itemMessage.document.meta.updated).format("MMM D  hh:mm:ss a")}</p>
