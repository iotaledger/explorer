        ...
        <div>
          {this.state.version && this.state.version === "legacy" && (
            <div className="section">
              <div className="legacy-method">
                <span>
                  This DID was created by a deprecated version of the identity library. If this is your DID you can recreate it using the{" "}
                </span>
          ...
          <div className="section">
                  ...
                  <MessageTangleState
                    ...
                    onClick={
                      this.state.metadata?.referencedByMilestoneIndex ?
                        (messageId: string) => this.props.history.push(`/${this.props.match.params.network}/search/${messageId}`)
                      : undefined
                    }
                  />
                )}
            ...
            <div className="section--data">
              ...
              {this.state.resolvedIdentity && !this.state.error && this.state.resolvedIdentity?.messageId !== this.EMPTY_MESSAGE_ID && (
                <Fragment>
          ...
          {this.state.isIdentityResolved && this.state.version && <IdentityHistory version={this.state.version} {...this.props} />}
        </div>
      </div>
    );
  }
