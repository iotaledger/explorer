...
class Transaction extends Component<TransactionProps, TransactionState> {
  ...
  public render(): ReactNode {
    return this.props.tableFormat ?
        <tr>
          <td className="value code highlight">
            <Link to={`/${this.props.network}/message/${this.props.messageId}`} className="margin-r-t">
              {this.props.messageId}
            </Link>
          </td>
          <td>{this.props.date ?? <Spinner />}</td>
          ...
          <td className={`amount ${this.props.amount && this.props.amount < 0 ? "negative" : "positive"}`}>
            {this.props.amount === undefined ?
              <Spinner />
            : UnitsHelper.formatBest(this.props.amount ?? 0)}
          </td>
        </tr>
      : <div className="transaction-card">
          ...
          <div className="field">
            ...
            <div className="value">{this.props.date ?? <Spinner />}</div>
          </div>
          <div className="field">
          ...
          <div className="field">
            ...
            <div className="value">
              {this.props.messageTangleStatus ?
                <MessageTangleState network={this.props.network} status={this.props.messageTangleStatus} />
              : <Spinner />}
            </div>
          </div>
          <div className="field">
            <div className="label">Amount</div>
            <div className={`amount ${this.props.amount && this.props.amount < 0 ? "negative" : "positive"}`}>
