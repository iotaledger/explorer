                ...
                <React.Fragment key={idx}>
                  <div className="row middle">
                    ...
                    <div className="card--value pointer amount-size row end">
                      ...
                      >
                        {this.state.isInputBalanceFormatted.includes(idx) ? `${input.amount} i` : UnitsHelper.formatBest(input.amount)}
                      </span>
              ...
              {this.props.outputs.map((output, idx) => (
                <React.Fragment key={idx}>
                  <div className="row middle">
                    ...
                    >
                      <div
                        className={classNames("margin-r-t", "card--content__input--dropdown", "card--content__flex_between", {
                    ...
                    <div className="card--value pointer amount-size row end">
                      ...
                      >
                        {this.state.isOutputBalanceFormatted.includes(idx) ? `${output.amount} i` : UnitsHelper.formatBest(output.amount)}
                      </span>
