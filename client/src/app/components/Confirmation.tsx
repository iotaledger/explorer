    ...
    return (
      ...
      >
        ...
        {this.props.state === "confirmed" &&
          `Confirmed${
            this.props.milestoneIndex !== undefined && this.props.milestoneIndex > 1 ? ` by MS ${this.props.milestoneIndex}` : ""
          }`}
        ...
        {this.props.state === "conflicting" &&
          `Conflicting${
            this.props.milestoneIndex !== undefined && this.props.milestoneIndex < 0 ? ` at MS ${this.props.milestoneIndex}` : ""
          }`}
      </div>
    );
  }
