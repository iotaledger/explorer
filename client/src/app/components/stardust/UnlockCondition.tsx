            ...
            {unlockCondition.type === UnlockConditionType.StorageDepositReturn && (
              <React.Fragment>
                ...
                <div className="card--value row">
                  <span className="pointer margin-r-t" onClick={() => this.setState({ isFormattedBalance: !isFormattedBalance })}>
                    {formatAmount(Number((unlockCondition as StorageDepositReturnUnlockCondition).amount), tokenInfo, !isFormattedBalance)}
                  </span>
                </div>
              </React.Fragment>
            )}
