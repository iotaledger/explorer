...
import WebglAtlas from "vivagraphjs/src/WebGL/webglAtlas";
 ...
 */
export function webglImageNodeProgram(tilesPerTexture) {
    ...
    const tilesPerTexture = tilesPerTexture || 1024;
    let atlas;
    let program;
    let gl;
    let buffer;
