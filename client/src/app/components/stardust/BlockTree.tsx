...
import "./BlockTree.scss";
import { BlockTreeProps } from "./BlockTreeProps";
import { EdgeUI, ItemUI, BlockTreeState, TreeConfig } from "./BlockTreeState";
...
/**
 * Component which will show the block tree page.
 */
class BlockTree extends Component<BlockTreeProps, BlockTreeState> {
    /**
     * Create a new instance of BlockTree.
     * @param props The props.
     */
    constructor(props: BlockTreeProps) {
        super(props);
        this.state = {
            ...
            items: [],
            edges: [],
            currentBlock: this.props.blockId,
            isBusy: false
        };
    }
    ...
    public scrollToBlockTree() {
        const top = document?.getElementById("block-tree")?.offsetTop ?? 0;
        const OFFSET = 200;
        window.scrollTo({
            left: 0,
            top: top - OFFSET,
    ...
    public componentDidUpdate(prevProps: BlockTreeProps): void {
    ...
    public render(): ReactNode {
        return (
            <React.Fragment>
                <div
                    className="block-tree-title row margin-b-m"
                    style={{
                    ...
                    {this.state.items?.map(item => (
                        <div
                            ...
                            onClick={() => {
                                ...
                                this.setState({ currentBlock: item.id, isBusy: true }, () => {
