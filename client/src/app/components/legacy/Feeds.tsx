...
abstract class Feeds<P extends RouteComponentProps<{ network: string }>, S extends FeedsState> extends Currency<P, S> {
   ...
   * Feed client.
   */
  protected _feedClient?: LegacyFeedClient;

  /**
   * Api client.
   */
  protected _apiClient?: LegacyApiClient;
  ...
  private initNetworkServices(): void {
    ...
    this._feedClient = ServiceFactory.get<LegacyFeedClient>(`feed-${this.props.match.params.network}`);
