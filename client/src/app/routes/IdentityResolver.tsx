            ...
            <div className="row">
              <div className="cards">
                {!this.props.match.params.did && (
                  <Fragment>
                    {this.props.protocolVersion === LEGACY && <div className="unsupported-network">This network is not supported!</div>}
                    ...
                    <div>
                      ...
                      <div>
                        <p className="tool-description">
                          The Identity Resolver is a tool for resolving Decentralized Identifiers (DIDs) into their associated DID Document,
                          by retrieving the information from an IOTA or Shimmer network.
                        </p>
                      </div>
                      {this.props.protocolVersion !== LEGACY && (
                        <div className="row middle margin-b-s row--tablet-responsive">
                          <IdentitySearchInput
                            compact={false}
                            onSearch={(e) => {
                              this.props.history.push(`/${this.props.match.params.network}/identity-resolver/${e}`);
                            }}
                      ...
                      {this.state.didExample && this.props.protocolVersion === STARDUST && (
                        <button
                          ...
                          onClick={() => {
                            this.props.history.push(`/${this.props.match.params.network}/identity-resolver/${this.state.didExample}`);
                          }}
                          type="button"
                        >
                          DID Example
