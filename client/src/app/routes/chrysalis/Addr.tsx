      ...
      this.setState(
        {
          ...
          bech32AddressDetails: Bech32AddressHelper.buildAddress(this._bechHrp, result.address.address, result.address.addressType),
                ...
                <div className="section">
                  ...
                  <div className="row space-between general-content">
                    <div className="section--data">
                      <Bech32Address addressDetails={this.state.bech32AddressDetails} advancedMode={true} showCopyButton={true} />
                  ...
                  <div className="section transaction--section">
                    ...
                    {this.txsHistory.length > this.state.pageSize && (
                      <div className="sort-disclaimer">
                        <span>When displayed across multiple pages, the transaction history may lose exact ordering.</span>
                      </div>
                    )}
