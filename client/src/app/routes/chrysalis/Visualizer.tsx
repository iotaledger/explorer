...
class Visualizer extends Feeds<RouteComponentProps<VisualizerRouteProps>, VisualizerState> {
                  ...
                  <>
                    ...
                    <div className="card--value overflow-ellipsis">
                      <a
                        ...
                        href={`${window.location.origin}${RouteBuilder.buildItem(this._networkConfig, selectedFeedItem.id)}`}
                      >
                        {selectedFeedItem.id}
                      </a>
                    </div>
                    ...
                    {selectedFeedItem?.properties?.Index && (
                      <>
                        <div className="card--label">Index UTF8</div>
                        <div className="card--value overflow-ellipsis">
                          <a
                            className="button"
                            target="_blank"
                            rel="noopener noreferrer"
                            href={`${window.location.origin}/${this.props.match.params.network}/indexed/${
                        ...
                        <div className="card--label">Index Hex</div>
                        <div className="card--value overflow-ellipsis">
                          <a
                            className="button"
                            target="_blank"
        ...
        <div className="row middle margin-t-s">
          <div className="card key fill">
            <div className="card--content row row--tablet-responsive middle wrap">
              ...
              <>
                <div className="visualizer--key visualizer--key__value referenced">Referenced</div>
                <div className="visualizer--key visualizer--key__value included">Included</div>
                <div className="visualizer--key visualizer--key__value conflicting">Conflicting</div>
              </>
  ...
  private setupGraph(graphElem: HTMLElement | null): void {
    ...
    if (graphElem && !this._graph) {
      ...
      this._graphics.node((node) => this.calculateNodeStyle(node, this.testForHighlight(this.highlightNodesRegEx(), node.id, node.data)));
