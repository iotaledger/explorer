                            ...
                            <div className="section--data section-nft-detail">
                                ...
                                <div className="nft-info">
                                    ...
                                    <div className="nft-list">
                                        <div className="item" onClick={() => this.setState({showGeneralItems: !this.state.showGeneralItems})}>
                                            <div className={classNames("margin-r-t", "card--content__input--dropdown", "card--content__flex_between", { opened: this.state.showGeneralItems })}>
                                                <DropdownIcon />
                                            </div>
                                            <span>General</span>
                                        </div>
                                        ...
                                        <div className="item" onClick={() => this.setState({showAttributes: !this.state.showAttributes})}>
                                            <div className={classNames("margin-r-t", "card--content__input--dropdown", "card--content__flex_between", { opened: this.state.showAttributes })}>
                                                <DropdownIcon />
                                            </div>
                                        ...
                                        <div className="item" onClick={() => this.setState({showDescription: !this.state.showDescription})}>
                                            <div className={classNames("margin-r-t", "card--content__input--dropdown", "card--content__flex_between", { opened: this.state.showDescription })}>
                                                <DropdownIcon />
                                            </div>
