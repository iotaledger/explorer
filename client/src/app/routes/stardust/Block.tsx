    ...
    block ?
      <React.Fragment>
        ...
        <TabbedSection
          key={blockId}
          tabsEnum={
            isMilestoneBlock ? { Payload: "Milestone Payload", Metadata: "Metadata", RefBlocks: "Referenced Blocks" }
            : isTransactionBlock ?
          ...
          <div className="block--header">
            <div className="header--wrapper">
              ...
              <BlockTangleState
                ...
                conflictReason={conflictReason}
                onClick={
                  metadata?.referencedByMilestoneIndex ? (theBlockId: string) => history.push(`/${network}/block/${theBlockId}`) : undefined
                }
              />
            </div>
