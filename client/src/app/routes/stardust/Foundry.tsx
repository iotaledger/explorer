...
const Foundry: React.FC<RouteComponentProps<FoundryProps>> = ({
  ...
  if (foundryDetails && foundryOutput) {
    ...
    const controllerAliasBech32 =
      controllerAlias ? Bech32AddressHelper.buildAddress(bech32Hrp, controllerAlias, AddressType.Alias) : undefined;
          ...
          {controllerAlias && controllerAliasBech32 && (
            <div className="section--data">
              ...
              <div className="value code highlight">
                <TruncatedId id={controllerAlias} link={`/${network}/addr/${controllerAliasBech32.bech32}`} showCopyButton />
              </div>
            </div>
          )}
          <div className="section--data">
    ...
    <div className="foundry">
      <div className="wrapper">
        <div className="inner">
          ...
          {foundryError ?
            <NotFound searchTarget="foundry" query={foundryId} />
          : foundryContent}
        </div>
      </div>
    </div>
