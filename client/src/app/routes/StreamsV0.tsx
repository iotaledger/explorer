                  ...
                  <div className="card--content">
                    <div className="row middle margin-b-s row--tablet-responsive">
                      ...
                      <input
                        ...
                        onChange={(e) => this.setState({ root: e.target.value.toUpperCase() }, () => this.validate())}
                    ...
                    <div className="row margin-b-s row--tablet-responsive">
                      ...
                      <input
                        ...
                        onChange={(e) => this.setState({ sideKey: e.target.value.toUpperCase() }, () => this.validate())}
                            ...
                            {item.messageType !== "Trytes" && (
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  oldPackets[idx].showRawMessageTrytes = !oldPackets[idx].showRawMessageTrytes;
                                  this.setState({
                                    packets: oldPackets,
                                  });
                                }}
