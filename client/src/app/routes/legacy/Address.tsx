...
class Address extends AsyncComponent<RouteComponentProps<AddressRouteProps>, AddressState> {
  ...
  public async componentDidMount(): Promise<void> {
    ...
    if (this.state.address) {
      ...
      const balance = await this._tangleCacheService.getAddressBalance(this.props.match.params.network, this.props.match.params.address);
                  ...
                  <div className="card--content">
                    ...
                    {this.state.balance !== undefined && this.state.balance !== 0 && (
                      <div className="row fill margin-t-s margin-b-s value-buttons">
                        ...
                        <div className="col">
                          <CurrencyButton marketsRoute={`/${this.props.match.params.network}/markets`} value={this.state.balance ?? 0} />
                        </div>
                      </div>
                    )}
                    {this.state.balance !== undefined && this.state.balance === 0 && (
