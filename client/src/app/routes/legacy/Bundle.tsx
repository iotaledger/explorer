        ...
        if (!isMissing) {
          ...
          bundleGroups.push({
            inputs: bundleGroupsPlain[i]
              ...
              .map((t) => ({
                details: t,
                valueCurrency: this._currencyData ? this._currencyService.convertIota(t.tx.value, this._currencyData, true, 2) : "",
              })),
                            ...
                            {group.inputs.map((item, idx2) => (
                              <div className="card--row" key={idx2}>
                                ...
                                <div className="card--value">
                                  <Link to={`/${this.props.match.params.network}/transaction/${item.details.tx.hash}`}>
