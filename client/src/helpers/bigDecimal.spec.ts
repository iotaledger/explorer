...
test("BigDecimal should construct with whole", () => {
    expect(new BigDecimal("0").toString()).toBe("0");
    expect(new BigDecimal("999").toString()).toBe("999");
});

test("BigDecimal should construct with decimal", () => {
    expect(new BigDecimal("0.12345").toString()).toBe("0.12");
});

test("BigDecimal should construct from big int", () => {
...
test("BigDecimal should round properly", () => {
...
test("BigDecimal should perform addition", () => {
...
test("BigDecimal should perform subtraction", () => {
...
test("BigDecimal should perform multiplication", () => {
...
test("BigDecimal should perform division", () => {
    let from = new BigDecimal("1000123321");
