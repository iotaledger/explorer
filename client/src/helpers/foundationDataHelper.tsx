  ...
  public static createValue(
    ...
    return (
      <React.Fragment key={key}>
        {info.label && <span className="data-label" dangerouslySetInnerHTML={{ __html: FoundationDataHelper.buildLines(info.label) }} />}
        {info.value && <span className="data-value" dangerouslySetInnerHTML={{ __html: FoundationDataHelper.buildLines(info.value) }} />}
