 ...
 */
export function useAddressAliasOutputs(network: string, addressBech32?: string): [IOutputResponse[] | null, boolean] {
    ...
    useEffect(() => {
        ...
        if (addressBech32) {
            ...
            void (async () => {
                tangleCacheService.addressAliasOutputs(network, addressBech32).then(response => {
