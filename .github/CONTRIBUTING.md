# Contribute to the Tangle Explorer website

This document describes how to contribute to the Tangle Explorer website.
...
To report a bug, [open a new issue](https://github.com/iotaledger/explorer/issues/new), and be sure to include as many details as possible, using the template.
...
**Ensure the feature has not already been suggested** by searching on GitHub under [**Issues**](https://github.com/iotaledger/explorer/issues).
